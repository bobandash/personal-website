...
export default function LandingScreen() {
  ...
  return (
    <div className="bg-primary relative flex h-screen flex-grow font-bold">
      <div className="mx-auto flex w-11/12 max-w-[1400px] flex-col items-center justify-center gap-4 sm:gap-7 md:gap-8 2xl:gap-12">
        ...
        <h2 className="line-3 xs:text-2xl pointer-events-none translate-y-1/2 text-center text-xl uppercase text-white opacity-0 sm:text-5xl 2xl:text-6xl">
